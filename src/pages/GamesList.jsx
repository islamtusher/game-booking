...
const GamesList = () => {
    ...
    const handleGameDelete = (id) => {
        if (token) {
            axios.delete(`http://localhost:5000/games?id=${id}`, {
                headers : {'accessToken' :  token}
            })
            .then(function (resp) {
                if (resp.status === 200) {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className='d-flex align-items-center justify-content-center' style={{gap: '10px'}}>
                                                ...
                                                <svg onClick={()=>handleGameDelete(game._id)} enableBackground="new 0 0 40 40"  width="20" height="20" id="Слой_1" version="1.1" viewBox="0 0 40 40" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
